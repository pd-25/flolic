...
<section id="banner-slider" class="banner-slider">
        ...
        <div class="carousel-inner" role="listbox">
		  ...
		  <canvas id="canvas"></canvas>
            <div class="carousel-caption">
			  ...
			  <p class="bannercap">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quae quis, ipsam. there a maiores soluta facere, accusantium modi.</p>
			  <a href="contact-us.html" class="banner-btn">Contact Us</a>
            </div>
          </div> 
	...
	<div class="container">
		...
		<p>We, Frolic Services, situated at Purba Sinthee, Kolkata, West Bengal, are accredited electrical contractors, working towards the goal of helping our customers with a smooth experience and ensure that all electrical works are undertaken at highest standards. We provide electrical services at an affordable rate and also give tips to our customers on how to maintain the longevity of electrical devices through our highly skilled staff.</p>
		<div class="row">
		<div class="col-lg-6">
		<div class="media">
...
<ul class="wel-list">
	...
	<div class="container">
	  <div class="row justify-content-center">
		...
		<p class="sechead">Maecenas convallis augue eu tortor commodo imperdiet. Donec fermentum maximus velit laoreet rhoncus. Aenean volutpat metus et maximus pharetra.</p>
		</div>
		</div>
	  <div class="row">
        ...
        <div id="owl-service" class="owl-carousel owl-theme">     
          <div class="item">
		  <div class="media">
  <img src="{{asset('frontend/images/serv-icon.png')}}" class="img-fluid" alt="...">
  <div class="media-body align-self-center">
    <h5 class="mt-0">Electrical Design</h5>
  </div>
</div>
		  <div class="pro-box">
  <p>Electrical designing is a significant aspect of creating safe, efficient, and functional electrical systems...</p>
  ...
  <div class="media-body align-self-center">
    <h5 class="mt-0">HVAC Design</h5>
		  ...
		  <div class="pro-box">
  <p>HVAC (Heating, Ventilation, and Air Conditioning) design is an important aspect of creating indoor environments...</p>
  ...
  <div class="media-body align-self-center">
    <h5 class="mt-0">PHE Design</h5>
		  ...
		  <div class="pro-box">
  <p>PHE (Public Health Engineering) design is a specialized field focused on planning and implementing water supply...</p>
  ...
  <div class="media-body align-self-center">
    <h5 class="mt-0">Fire System Design</h5>
		  ...
		  <div class="pro-box">
  <p>Fire system designing is a critical aspect of ensuring the safety of buildings and occupants by implementing...</p>
  ...
  <div class="media-body align-self-center">
    <h5 class="mt-0">ELV Network Design</h5>
		  ...
		  <div class="pro-box">
  <p>ELV (Extra Low Voltage) network design is a specialized field in the realm of electrical engineering that focuses...</p>
  ...
  <div class="media-body align-self-center">
    <h5 class="mt-0">CCTV & Secuirity System Design</h5>
		  ...
		  <div class="pro-box">
  <p>CCTV (Closed-Circuit Television) and security system designing is a specialized field focused on creating comprehensive...</p>
...
<div class="row">
	  ...
	  <img src="{{asset('frontend/images/why-pic.jpg')}}" class="img-fluid">
		...
		<p class="sechead">Why face the electrical hazards, when we offer a variety of electrical installation and repair solutions. Be it a switch board repair, a wiring problem, light fittings, installation and repair of electrical devices, our professionals are equipped to deal with it. Our professionals are skillfully trained to handle the most complex electrical problems.</p>
<div class="media why-us-ctn mb-4">
  <img src="{{asset('frontend/images/why-icon.png')}}" class="align-self-center mr-3" alt="...">
  <div class="media-body">
    <h5 class="mt-0">We provide <span>High Quality Equipment</span></h5>
    <p>Phasellus egestas, massa id efficitur tristique, nibh orci viverra quam, quis consequat lectus orci quis mi.</p>
  </div>
</div>
<div class="media why-us-ctn mb-4">
  <img src="{{asset('frontend/images/why-icon.png')}}" class="align-self-center mr-3" alt="...">
...
<section id="hm-contact-section">
	...
	<div class="col-lg-12">
	<div class="media">
  <img src="{{asset('frontend/images/phone-icon.png')}}" class="align-self-center mr-3" alt="...">
  <div class="media-body">
...
<section id="gallery-section">
  ...
  <img src="{{asset('frontend/images/gal-pic1.jpg')}}" class="img-fluid">	  
  <h3>Alipore Central Jail</h3>
          </div>
		   </div>
<div class="item">
		  <div class="gallery-img-box">
...
<div class="col-lg-12 text-center">
<a href="our-project.html" class="hm-btn">View Full Project</a>
</div>
</div>
</div>
</section>
...
<section id="video-section">
	...
	<div class="video-box">
		<a class="youtube-link" youtubeid="UdtzEh3AlLM"> <span class="playbtn-img"><img src="{{asset('frontend/images/play-btn.png')}}"></span></a> 
        </div>
		 </div>
		<div class="col-lg-6 snd-video-box">
		<div class="video-box">
		<a class="youtube-link" youtubeid="gTJaRXAEK70"><span class="playbtn-img"><img src="{{asset('frontend/images/play-btn.png')}}"></span></a> 
        </div>
		</div>
...
<section id="testimonial-section">
  ...
  <img src="{{asset('frontend/images/comma.png')}}" class="comma img-fluid" alt="">
...
<div class="item">
		  <div class="testimonials-thumb">
  <img src="{{asset('frontend/images/comma.png')}}" class="comma img-fluid" alt="">
  <p>Curabitur velit arcu, pellenteue is varius at, porta eget ex. Nulla phtra semper tor, ornare tincidunt est fcibus at. Pellentsque arcu justo, finibus non volutpat a, maximus ut tellus. Duisis nec libero ultricies tincidunt ut a risus fusce ut convallis purus dui, dict lectus. </p>
<div class="media">
  <img src="{{asset('frontend/images/profile.png')}}" class="mr-3" alt="...">
  <div class="media-body align-self-center">
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14735.649654198663!2d88.43920648097992!3d22.58237893499913!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a0275da9505920d%3A0xfb86b399730eafd5!2sDongfang%20Electric%20(I)%20Pvt.%20Ltd.!5e0!3m2!1sen!2sin!4v1708522721906!5m2!1sen!2sin" width="100%" height="510" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
</div>
</div>
</div>
</section>
