...
<section id="inn-banner-slider" class="banner-slider">
  ...
  <a href="single-project.html"><img src="{{asset('frontend/images/gal-pic1.jpg')}}" class="img-fluid"></a> 
  <h3><a href="single-project.html">Alipore Central Jail</a></h3>  
          </div>
            </div>
			<div class="col-lg-4 col-md-4 col-sm mb-4">
               <div class="gallery-img-box">
  <a href="single-project.html"><img src="{{asset('frontend/images/gal-pic2.jpg')}}" class="img-fluid"></a> 
  <h3><a href="single-project.html">Aircraft Musium</a></h3>  
          </div>
            </div>
			<div class="col-lg-4 col-md-4 col-sm mb-4">
               <div class="gallery-img-box">
  <a href="single-project.html"><img src="{{asset('frontend/images/gal-pic3.jpg')}}" class="img-fluid"></a> 
