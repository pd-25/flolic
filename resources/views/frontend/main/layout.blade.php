...
<div id="top-header">
 ...
 <ul>
 <li><i class="fa fa-phone" aria-hidden="true"></i> <a href="">+91-8981228599</a> / <a href="">+91 9831821332</a></li>
 <li><i class="fa fa-envelope aria-hidden="true"></i> <a href="">frolic.services@gmail.com</a></li>
 </ul>
...
<p><i class="fa fa-map-marker aria-hidden="true"></i> Dong Fang building,  5th Floor, Suit no - 602, Newtown,  Kolkata- 700156</p>
 </div>
...
<div id="second-header">
 ...
 <nav class="navbar navbar-expand-lg navbar-light mainmenu">
  <button aria-label="Toggle navigation" aria-expanded="false" aria-controls="navbarNav" data-target="#navbarNav" data-toggle="collapse" type="button" class="navbar-toggler">
  ...
  <div id="navbarNav" class="collapse navbar-collapse">
    <ul class="nav navbar-nav ml-auto">
	 ...
	 <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#">Services</a>
		...
		<li><a href="cctv-and-security-system-design">CCTV and security system design</a></li>
        </ul>
      </li>	  
<li class="nav-item">
			...
			<div class="container">			
				<div class="row">			
					...
					<img src="{{asset('frontend/images/logo.png')}}" class="img-fluid mb-3">
						<p>Lorem ipsum dolor sit amctetur adipiscing elit. Vestibulum ultricies elementum eros, vitae viverra nibh consequat eu.</p>	
...
<br>
<p class="footer-phone"><i class="fa fa-phone" aria-hidden="true"></i> +91-8981228599 / +91 9831821332</p>
<p class="footer-phone"><i class="fa fa-envelope" aria-hidden="true"></i> frolic.services@gmail.com</p>
		...
		<div id="footer-copyright">
			<div class="container">			
				<div class="row text-center">			
					<div class="col-lg-12">
						<p>Copyright © 2023, Frolic Services. All Rights Reserved | Design and Developed By <a href="https://www.webredas.com/">Webredas</a></p>	 
					</div>
				</div>
			</div>
		</div>
